...
{
    public class HairCutting : HairStyleState
    {
        public HairCutting(HairStyleController hairStyleController) : base(hairStyleController)
        {
        }
        ...
        private void OnInteractedWithHair(Collider2D collider)
        {
            if (HairCollection.TryGetValue(collider, out Hair hair))
            {
                ...
                hair.Shorten(hairBrushPosition, false);
            }
        }
    }
}
